...
df = data_Vdss # The steady state volume of distribution. It refelect the drug ability to cross
 membranes and to bind in tissues.

df = df[df['Vdss /L.kg-1'] < 3] # removing outliers
...
regressor=SVR(kernel='rbf',verbose=False, C = 1.5, gamma = 0.1, epsilon=0.5)
