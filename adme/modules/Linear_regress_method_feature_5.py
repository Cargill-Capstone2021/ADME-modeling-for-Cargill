...
df = data_IC_50 # half-maximal inhibitory concentration (how much drug is needed to inhibit a biological process by half, thus providing a measure of potency
