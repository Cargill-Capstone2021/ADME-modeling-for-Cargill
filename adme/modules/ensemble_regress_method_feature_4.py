...
from sklearn.ensemble import BaggingClassifier, RandomForestRegresson, GradientBoostingClassifier
...
df = data_CL_max # Clearance defined as the proportionality constast between the rate of drug elimination
and the drug concentration. In pharmacology, clearance is a pharmacokinetic measurement of the volume of 
plasma from which a substance is completeley removed per unit time. 
