...
df = data_T_half # Eliminiation half life. It is the time it takes for the elimniation processess to reduce the
plasma concentration or the amount of drug in the body by 50 percent.
